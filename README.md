...
### 07_cluster_interpretation.ipynb


* Cluster membership inspection
* Average pitch contour per cluster
* Comparative cluster visualization
* Musical interpretation of clusters
* Exploration of melodic profile similarities across clusters


## Outputs

* Statistical summaries
* Pitch contour visualizations
* PCA visualizations
